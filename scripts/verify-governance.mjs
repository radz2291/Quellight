 ...
 *  - any VICT dependency is not the exact coordinated 0.2.0 release pin;
...
// 5. Dependency graph: exact 0.2.0 coordinated set, registry-only.
...
// 7. The audited 0.2.0 boundary is genuinely installed (no local stand-in).
