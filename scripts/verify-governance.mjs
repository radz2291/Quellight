 ...
 *  - any VICT dependency is not the exact coordinated 0.3.1 release pin;
...
// 5. Dependency graph: exact 0.3.1 coordinated set, registry-only.
...
// 7. The adopted 0.3.1 boundary is genuinely installed (no local stand-in).
