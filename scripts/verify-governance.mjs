 ...
 *  - any VICT dependency is not the exact coordinated 0.3.1-rc.2 release pin;
...
// 5. Dependency graph: exact 0.3.1-rc.2 coordinated set, registry-only.
...
// 7. The adopted 0.3.1-rc.2 boundary is genuinely installed (no local stand-in).
