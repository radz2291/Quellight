 ...
 * coordinated verification candidate `@victframework/*@0.3.1`
 ...
 *     release pin (`@victframework/*@0.3.1`) — no range, tag, workspace,
 ...
 *     anything but exactly 0.3.1 (a mixed set fails);
