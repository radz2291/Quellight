 ...
 * verified public set `@victframework/*@0.2.0`
 ...
 *     release pin (`@victframework/*@0.2.0`) — no range, tag, workspace,
 ...
 *     anything but exactly 0.2.0 (a mixed 0.1.x/0.2.0 set fails);
...
//    and the FULL resolved graph (direct + transitive) at exactly 0.2.0.
