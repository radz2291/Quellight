...
Stage 07D: D1a contract FROZEN; D1/D3 and D2 IMPLEMENTED; D4 real-use proof PREPARED, made deterministic (contract @2), and EXECUTED EXACTLY ONCE (failed truthfully; root cause since PROVEN — local harness defects, all fixed and loopback-proven end-to-end) — execution NOT rerun; a new structured-session authorization is machinery-ready (real-credential validity untested); organic-use window NOT begun; Stage 07D is NOT verified or formally closed.
