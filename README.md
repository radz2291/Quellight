...
Stage 07D: D1a contract FROZEN; D1/D3 and D2 IMPLEMENTED; D4 real-use proof PREPARED, made deterministic (contract @2), and EXECUTED EXACTLY ONCE under owner authorization 2026-09-23 — the structured session FAILED TRUTHFULLY (aborted at the first provider turn; sealed QLT_D4_PROOF_POINT_FAILED; receipt consumed; no rerun); organic-use window NOT begun; Stage 07D is NOT verified or formally closed.
