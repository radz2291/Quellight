...
Stage 07D: D1a contract FROZEN; D1/D3 and D2 IMPLEMENTED; D4 real-use proof PREPARED, made deterministic (contract @2), and EXECUTED EXACTLY ONCE (failed truthfully; root cause PROVEN and remediated end-to-end; the attempt-1 bundle is owner-archived byte-pinned and the evidence lifecycle is fail-closed) — execution NOT rerun; active output paths CLEAN (a fresh owner authorization can create exactly one new attempt); organic-use window NOT begun; Stage 07D is NOT verified or formally closed.
